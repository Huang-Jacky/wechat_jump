...
public class TargetCenter {
    ...
    BottleNextPosition bottleNextPosition = new BottleNextPosition();
...
//                    System.out.println("top, x: " + i + ", y: " + j);
        ...
        if (targetR == BottleNextPosition.TARGET && targetG == BottleNextPosition.TARGET && targetB == BottleNextPosition.TARGET) {
            return bottleNextPosition.find(image, ret[0], ret[1]);
        }
...
//        System.out.println("right, x: " + ret[4] + ", y: " + ret[5]);
    ...
    public static void main(String... strings) throws IOException {
        //  int[] excepted = {0, 0};
        TargetCenter t = new TargetCenter();
